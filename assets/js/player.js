    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="40" height="40" data-play="playable" class="not-started playable">',
                ...
                '<circle class="progress-track" cx="50" cy="50" r="47.45" stroke="" stroke-opacity="0.25" stroke-linecap="round" fill="#FF396F" stroke-width="0"/>',
                '<line x1="40" y1="30" x2="60" y2="60" stroke="#FFFFFF" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '<line x1="40" y1="60" x2="60" y2="30" stroke="#FFFFFF" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '</g>',
            ...
            $.each(this, function (a, b) {
                ...
                template = template.replace('width="50"','width="'+ audio.data('size')  +'"');
                template = template.replace('height="50"','height="'+ audio.data('size')  +'"');
            ...
            $(_.settings.controlsObj).on('click', function (e) {
                ...
                switch (obj.class.replace('playable', '').trim()) {
                    ...
                    //     break;
                    case 'ended':
                        obj.playObj.attr('class', 'not-started stop');
